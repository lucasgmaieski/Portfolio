        ...
        <div className="pb-10 px-2 md:pb-20 bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-themecolor/[3%] via-themecolor/[1%] to-themecolor/[1%] relative overflow-hidden">
            <section className="max-w-5xl m-auto" id="contact">
                <div data-aos="zoom-in" data-aos-duration="1000">
                    <h2 className="text-4xl font-semibold text-bold m-auto relative w-fit before:content-[''] before:absolute before:w-full before:h-1 before:bg-gradient-to-r from-themecolor/0 via-themecolor to-themecolor/0 before:-bottom-1.5 before:left-0">Contato</h2>
                </div>
                ...
                <div className="flex gap-12 px-1 items-start flex-col md:flex-row md:gap-8 relative z-10">
                    ...
                    <div className="relative w-full md:w-fit" data-aos="fade-left" data-aos-duration="1000">
                        <Link to={'mailto:lucasgrigol@gmail.com'} target="_blank" className="font-bold w-fit flex gap-1 items-center mb-2 duration-500 transition-transform hover:translate-x-3 hover:text-themecolor" title=""><AiOutlineMail className="text-themecolor text-4xl"/>lucasgrigol@gmail.com</Link>
